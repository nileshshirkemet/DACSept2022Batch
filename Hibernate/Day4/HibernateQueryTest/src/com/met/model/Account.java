...
@NamedQueries({
	...
	@NamedQuery(name = "getAllAccounts", query = "from com.met.model.Account order by balance desc"),
	@NamedQuery(name = "filterAccounts", query = "from com.met.model.Account where name=:nameVal")
